...
In addition to the limit spectra, we show in Figure~\ref{fig:artificial_sim_outs}] the time series and power spectra for individual realisations of the simulations.

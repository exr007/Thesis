...
In addition, it is quite clear from Figure~\ref{fig:FD_201203_8001} and Figure~\ref{fig:FD_201207_8001} that station 8001 (Eindhoven) displays a semi-persistent diurnal variation in the count rate. We typically expect a diurnal variation of $<1\%$ \citep{mishra_study_2007, mishra_cosmic_2008, dubey_cosmic_2016, thomas_decadal_2017}, but here we see an increase of $\sim$100\%, which again suggests there may be an additional component from thermally induced noise due to diurnal temperature variation.%know that daily variation is a combination of the \gls{cr} anisotropy in the interplanetary space and a consequence of the rotation of the Earth meaning detectors look in different directions over the course of a day; however, we

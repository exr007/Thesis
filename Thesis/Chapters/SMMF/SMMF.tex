...
In Chapter~\ref{chap:rmode} we acquired Solar Dynamics Observatory Helioseismic and Magnetic Imager (SDO/HMI) full-disk magnetograms, using the {\verb SunPy } python module \citep{barnes_sunpy_2020}, to support our investigations into Rossby waves.

...
\begin{figure}[ht!]
	\centering
	\subfloat[BiSON SMMF 40-second cadence time series \label{fig:SMMF_TS}]{\includegraphics[width=0.98\columnwidth]{BiSON_full_TS.png}} \\ 
	\centering
	\subfloat[Power spectral density of the BiSON SMMF \label{fig:SMMF_FT}]{\includegraphics[width=\columnwidth]{BiSON_lin_mu_PSD.png}}
...
\begin{figure}[ht!]
	...
	{\includegraphics[width=0.47\columnwidth]{BiSON_vs_WSO.png}} 
	\qquad
	\subfloat[BiSON vs WSO PSDs \label{fig:BiSON_WSO_PSDs}]{\includegraphics[width=0.47\columnwidth]{BiSON_PSD_vs_WSO_PSD.png}}
